...
export const PROJECTEN: Project[] = [
  ...
  },
  {
    ...
    werkzaamheden: [
      ...
      "6 Alfen Eve Double Pro-line laadpunten installeren",
  ...
  {
    id: "4",
    titel: "Easee voor zonnepanelen-eigenaar",
    ...
    werkzaamheden: [
      ...
      "Easee Charge Up installeren op de oprit",
      "Easee-app koppelen met bestaande zonnepanelen voor slim laden op zonnestroom",
      "App-configuratie voor slim laden op zonnestroom",
    ],
    installatieduur: "Halve dag",
    bijzonderheden:
      "De klant had al 12 zonnepanelen en wilde zijn Volkswagen ID.4 laden met zelf opgewekte stroom. Via de Easee-app laadt de auto alleen wanneer er voldoende zon is, of automatisch in daluren als zonne-energie onvoldoende is.",
    resultaat:
    ...
    review: {
      ...
      rating: 5,
      quote:
        "Fantastische installatie en geweldig dat we nu op eigen stroom rijden. De Easee-app geeft ons alle inzicht. Binnen het uur was het geregeld.",
    },
    tags: ["Zonnepanelen", "Easee", "Slim laden"],
    gradientFrom: "#f59e0b",
    gradientTo: "#10b981",
    datum: "2024-07",
  },
  {
    id: "5",
    titel: "Easee Charge Core voor VvE-uitbreiding",
    ...
    werkzaamheden: [
      ...
      "8 extra Easee Charge Core laadpalen installeren",
