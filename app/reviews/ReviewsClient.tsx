...
const REVIEWS: Review[] = [
  ...
  { naam: "Familie Janssen", initialen: "FJ", woonplaats: "Eindhoven", type: "Particulier – Zonnepanelen + Volkswagen ID.4", datum: "juli 2024", rating: 5, quote: "Fantastische installatie en geweldig dat we nu op eigen stroom rijden. De Easee-app geeft ons alle inzicht. Binnen het uur was het geregeld.", geverifieerd: true },
